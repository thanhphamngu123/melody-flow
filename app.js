...
class MelodyFlow {
    ...
    bindEvents() {
        ...
        // GSAP & ScrollTrigger Mind-Blowing Choreography
        if (typeof gsap !== 'undefined') {
            ...
            ScrollTrigger.batch('.stat-capsule, .organic-feature-card, .step-card, .music-demo-widget, .comparison-card, .usecase-card, .faq-item', {
